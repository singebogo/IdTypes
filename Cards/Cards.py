...
class App(tk.Tk):
    ...
    def create_systray_icon(self):
        ...
        file = os.path.join(os.path.dirname('__file__'), "assers", "证件.png")
        # image = Image.open(file)
        # self.icon = pystray.Icon("icon", image, "cards-kxw-singebogo@163.com", menu)
